 <aside class="sidebar-left border-right bg-white " id="leftSidebar" data-simplebar>
     ...
     <nav class="vertnav navbar-side navbar-light">
         ...
         <ul class="navbar-nav {{ Route::currentRouteName() === 'dashboard' ? 'active' : '' }} flex-fill w-100 mb-2">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="emergency_dd">
                        ...
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('emergency.incidents') }}">
                                <i class="fa-solid fa-clipboard-list"></i> <span class="ml-1 item-text">Incident Logs</span>
                            </a>
                        </li>
                    </ul>
                </li>
             ...
             <ul class="navbar-nav flex-fill w-100 mb-2">
                <li class="nav-item dropdown">
                    ...
                    <ul class="collapse list-unstyled pl-4 w-100" id="casesModule">
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('cases.index') }}"><i class="fa-solid fa-folder-open"></i> <span class="ml-1 item-text">All Cases</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pl-3" href="{{ route('auditLog.index') }}""><i class="fa-solid fa-clock-rotate-left"></i> <span class="ml-1 item-text">Audit Logs</span></a>
                        </li>
                    </ul>
                </li>
